...
import { ResubmissionData, ResubmissionFormValues } from '@/utils/types';
import { handleGeolocation, handleGetCurrentLocation } from '@/utils/resubmissionHelpers';
import ExploreIcon from '@mui/icons-material/Explore';
import WhereToVoteIcon from '@mui/icons-material/WhereToVote';

// Lazy load SignupMap
const SignupMap = lazy(() => import('../authentication/map/SignupMap'));
