        ...
        <div className="flex items-center justify-between">
          ...
          {user ? (
            ...
            <div className="flex items-center">
              <Link 
                to="/ride-history" 
                className="flex items-center space-x-2 text-gray-300 hover:text-white smooth-transition px-4 py-2"
              >
                <Clock size={18} />
                <span>Rides</span>
              </Link>
              <div className="relative group">
                <button className="flex items-center space-x-1 text-gray-300 hover:text-white smooth-transition">
                  <User size={18} />
                  <ChevronDown size={16} />
                </button>
                <div className="absolute invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 top-full left-0 mt-2 w-48 bg-gray-900 rounded-lg p-3 z-10 border border-gray-700">
                  <div className="py-1">
                    <Link to="/profile" className="block px-4 py-2 text-sm hover:bg-gray-800 rounded-md smooth-transition text-white">Profile</Link>
                    <Link to="/driver/login" className="block px-4 py-2 text-sm hover:bg-gray-800 rounded-md smooth-transition text-white">Login as Driver</Link>
                    <Link to="/login" className="block px-4 py-2 text-sm hover:bg-gray-800 rounded-md smooth-transition text-white"
                     onClick={() => {
