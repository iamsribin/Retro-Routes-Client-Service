...
//         if (res?.status === 201) {
//           setOtpPage(true);
//           toast({ description: "OTP sent successfully. Check your email", variant:"success" });
//         }
//       } catch (error: unknown) {
...
//         toast({ description: "Registration successful login and start ride!", variant: "success" });
//         navigate("/login");
//       }
//     } catch (error) {
//       handleCustomError(error);
...
//                           setOtp("");
//                           try {
//                             await postData(UserApiEndpoints.CHECK_USER, formik.values);
