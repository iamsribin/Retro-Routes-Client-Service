                                ...
                                <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-md sm:w-full sm:p-6">
                                    <form onSubmit={formikStatus.handleSubmit}>
                                        <div className="mt-2 text-center">
                                            ...
                                            <p className="mt-2 text-sm text-gray-500">Please provide details for status change</p>
                                        </div>
                                        <select
                                            name="status"
                                        ...
                                        <div className="text-center mt-1 text-red-500">
                                            <p className="text-xs">{formikStatus.touched.status && formikStatus.errors.status}</p>
                                        </div>
                                        <textarea
                                            name="reason"
                                            onBlur={formikStatus.handleBlur}
                                        ...
                                        />
                                        <div className="text-center mt-1 text-red-500">
                                            <p className="text-xs">{formikStatus.touched.reason && formikStatus.errors.reason}</p>
                                        </div>
                                        <div className="mt-5 sm:flex sm:justify-center gap-4">
                                            <button onClick={() => setStatusModal(false)} className="px-4 py-2 text-blue-600 rounded-md">Dismiss</button>
                                            <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-500">Update Status</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6">
                            ...
                            <div className="mt-6 space-y-4">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span>{new Date(userData.joiningDate).toLocaleDateString()}</span>
                                </div>
                                <div className="flex justify-between">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className={`badge ${userData.accountStatus === "Good" ? "badge-success" : "badge-error"} text-white`}>
