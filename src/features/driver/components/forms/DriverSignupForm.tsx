...
const DriverSignupForm = ({
    ...
    const handleOtpChange = (index: number, newValue: string) => {
        ...
        const padded = otp.toString().padStart(6, "0");
        const newOtpArr = [...padded];
        newOtpArr[index] = parsedValue.toString();
        setOtp(parseInt(newOtpArr.join(""), 10) || 0);
    };
