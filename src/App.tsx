      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path='/driver/signup' element={driver ? <Navigate to={'/driver/dashboard'}/>:<DriverSignupPage/>}/>
           ...
           <Route path='/admin/PendingDriverDetails/:id' element={admin ? <PendingDriverDetails /> : <Navigate to={'/login'}/>}/>
           <Route path='/admin/driverDetails/:id' element={admin ? <PendingDriverDetails /> : <Navigate to={'/login'}/>}/>
